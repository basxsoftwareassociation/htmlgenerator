...
Example:
    ...
    print(render(DIV("My list is:", OL(LI("not very long"), LI("having a good time"), LI("rendered with htmlgenerator"), LI("ending with this item"), )), {}))
    print(render(DIV("Hello world!", _class="success-message", style="font-size: 2rem", data_status="ok"), {}))
...
Example python object:
    ...
    print(render(DIV("Hello, here is some data: ", {"fingers": [1,2,3,4,5], "stuff": {"set": {1,2,3,3,3,3,3}}}), {}))
...
Example escaping:
    ...
    print(render(DIV("Hello, here is some HTML: ", '<div style="font-size: 2rem">Hello world!</div>'), {}))
    print(render(DIV("Hello, here is NOT some HTML: ", mark_safe('<div style="font-size: 2rem">Hello world!</div>')), {}))
...
Example:
    ...
    print(render(DIV("Hello, ", C("person.name")), {"person": {"name": "Alice", "occupation": "Writer"}}))
...
Example:
    ...
    print(render(BaseElement("Just", SPAN("some"), "elements", SPAN("without"), "parent"), {}))
